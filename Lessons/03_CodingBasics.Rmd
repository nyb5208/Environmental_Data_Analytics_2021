...
vector1[3] #3rd element of vector1, which is 5.3

# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) # 5x4 numeric matrix
matrix1
matrix2 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE) #`byrow=TRUE` tells R that matrix should be filled by rows
matrix2
...
matrix1[c(12, 14)] # row 12, column 14
matrix1[c(12:14)] # columns 12,13,14 
matrix1[2:4, 1:3] # rows 2,3,4 and columns 1,2,3
...
```{r}
#10-day temperature forecast for Durham, NC
#high and low temperatures found from weather.com for the days from Feb 1st to Feb 10th
high_temps<-c(40,43,46,51,55,51,45,34,44,50) 
low_temps<-c(32,26,23,40,34,36,18,20,27,31)
```
